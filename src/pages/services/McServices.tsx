  ...
  return (
    <section className="container-x py-16 md:py-24 bg-white">
      <header className="grid gap-8 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] md:items-end">
        <div>
          <p className="eyebrow text-[#E55625] font-bold">Services · MC</p>
        ...
        <div className="card p-5 text-sm text-gray-900 border-purple-pale bg-purple-50">
          <div className="text-xs uppercase tracking-[0.14em] text-gray-700 font-semibold">Ideal for</div>
          <p className="mt-2 text-gray-900">Weddings, ceremonies, fundraisers, and conferences with live program elements.</p>
        </div>
      </header>
      ...
      <div className="mt-10 grid gap-10 md:grid-cols-[minmax(0,1.2fr)_minmax(0,1.1fr)] md:items-start">
        <section aria-labelledby="mc-included-heading">
          <h2 id="mc-included-heading" className="text-sm font-semibold tracking-tightish text-gray-900">
            What&apos;s included
          </h2>
        ...
        >
          <div className="flex items-center gap-4">
            <TimelineConnector />
            <h2 id="mc-process-heading" className="text-sm font-semibold tracking-tightish text-gray-900">
              Process
            </h2>
          </div>
          <ol className="space-y-4 text-sm text-gray-900">
            <li>
              <div className="font-medium text-gray-900">1. Event narrative</div>
      ...
      <section className="mt-12" aria-labelledby="mc-gallery-heading">
        <h2 id="mc-gallery-heading" className="text-sm font-semibold tracking-tightish text-gray-900">
          Moments on mic
        </h2>
