  ...
  return (
    <section className="container-x py-16 md:py-24 bg-background">
      <header className="grid gap-8 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] md:items-end">
        <div>
          <p className="eyebrow text-accent font-bold">Services · Tent rentals</p>
          <h1 className="mt-4 font-display text-4xl tracking-tightish md:text-5xl text-text-primary font-bold">Structure that feels intentional.</h1>
        ...
        <div className="card p-5 text-sm text-text-primary border-teal-pale bg-teal-50">
          ...
          <p className="mt-2 text-text-primary">Outdoor weddings, corporate dinners, ceremonies, and multi-day festivals.</p>
        </div>
      </header>
      ...
      <div className="mt-10 grid gap-10 md:grid-cols-[minmax(0,1.2fr)_minmax(0,1.1fr)] md:items-start">
        <section aria-labelledby="tent-included-heading">
          <h2 id="tent-included-heading" className="text-sm font-semibold tracking-tightish text-text-primary">
            What&apos;s included
          </h2>
        ...
        >
          <div className="flex items-center gap-4">
            <TimelineConnector />
            <h2 id="tent-process-heading" className="text-sm font-semibold tracking-tightish text-text-primary">
              Process
            </h2>
          </div>
          <ol className="space-y-4 text-sm text-text-primary">
            <li>
              <div className="font-medium text-text-primary">1. Site and guest brief</div>
      ...
      <section className="mt-12" aria-labelledby="tent-gallery-heading">
        <h2 id="tent-gallery-heading" className="text-sm font-semibold tracking-tightish text-text-primary">
          Recent layouts
        </h2>
