          ...
          <div className="mt-6">
            ...
            <div className="flex gap-3">
              <a 
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-background-alt text-text-primary hover:bg-accent hover:text-white transition-colors"
                aria-label="Facebook"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center justify-center w-10 h-10 rounded-full bg-background-alt text-text-primary hover:bg-[#25D366] hover:text-white transition-colors"
                aria-label="WhatsApp"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center justify-center w-10 h-10 rounded-full bg-background-alt text-text-primary hover:bg-[#FF0000] hover:text-white transition-colors"
                aria-label="YouTube"
              >
